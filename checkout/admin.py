...
class OrderAdmin(admin.ModelAdmin):
    ...
    fields = ("order_number", "date", "full_name", "email", "phone_number", "country", "postcode", "town_r_city", "street_add_line1", "street_add_line2", "county", "delivery_cost", "order_total", "grand_total",)
