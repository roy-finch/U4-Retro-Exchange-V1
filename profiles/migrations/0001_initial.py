    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_town_r_city', models.CharField(blank=True, max_length=20, null=True)),
                ('default_street_add_line1', models.CharField(blank=True, max_length=80, null=True)),
                ('default_street_add_line2', models.CharField(blank=True, max_length=80, null=True)),
